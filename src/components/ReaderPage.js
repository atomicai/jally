  ...
  return (
    <div>
      <nav className="w-full h-14 flex justify-between mt-2">
        ...
        <div className="flex justify-evenly items-center text-md w-2/6">
          <span>Поиск</span>
          <span>Избранное</span>
          ...
          {isOpen ? (
            <div className="absolute right-28 top-20 border-2 border-red-400 rounded-lg p-4 flex flex-col items-center">
      ...
      <div className="ml-24 mt-10 flex">
        ...
        {filter ? (
          <div className="absolute right-80 top-40 border-2 border-red-400 rounded-lg p-4 flex flex-col text-md">
            <div>
            ...
            <button className="bg-red-300 mt-2 rounded-sm">Применить</button>
          </div>
        ) : null}
      </div>
